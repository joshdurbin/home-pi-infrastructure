...
- [hashi-armelv5-binaries](https://github.com/joshdurbin/hashi-armelv5-binaries) contains custom binaries for consul-template  
...
- [Official PI Zero Case](https://www.amazon.com/Official-Raspberry-Pi-Zero-Case/dp/B06Y593MHV/)
- [USB Power Supply](https://www.amazon.com/gp/product/B00MARDJZ4/)
- [PI Camera v2](https://www.amazon.com/gp/product/B01ER2SKFS/)
- [Mount Hardware](https://www.amazon.com/gp/product/B08D7LP8MY/)
- [Mini Tripod](https://www.amazon.com/gp/product/B006I1KQQI/)
- [Sandisk Extreme MicroSD Card](https://www.amazon.com/gp/product/B00M55BX3G/)
...
1. Download the lite version of Raspberry PI OS -- `wget https://downloads.raspberrypi.org/raspios_lite_armhf/images/raspios_lite_armhf-2020-08-24/2020-08-20-raspios-buster-armhf-lite.zip ~/Downloads`
...
4. Unzip and flash the image to the target disk: `sudo sh -c 'unzip -p ~/Downloads/raspios_lite_armhf-2020-08-24/2020-08-20-raspios-buster-armhf-lite.zip | sudo dd of=/dev/rdisk2 bs=32m'` (note that for this operation the device `diskX` is prefaced with an `r`, i.e. `disk2` becomes `rdisk2`)
...
Once you've flashed the 32 bit image to the SD card, alter the `/boot` volume in one additional way, establishing Wifi access on first boot. Following instructions from [this document](https://www.raspberrypi.org/documentation/configuration/wireless/headless.md), do the following:

Add a file to `/Volumes/boot/` as `wpa_supplicant.conf` (`/Volumes/boot/wpa_supplicant.conf`) with the contents:
...
- [h264 low-latency camera RTSP streaming](https://www.bensoftware.com/forum/discussion/3254/raspberry-pi-h264-rtsp-low-latency-camera-instructions)
